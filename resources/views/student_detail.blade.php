                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between flex-wrap gap-2">
                                            ...
                                            <a href="" class="btn btn-primary flex-grow-1">Payement History</a>
                                            <a href="" class="btn btn-primary flex-grow-1">View Complaints</a>
                                            <a href="" class="btn btn-primary flex-grow-1">Remaining Dues</a>
                                            <a href="" class="btn btn-primary flex-grow-1">View Reports</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
