                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{ route('staffs.index') }}" class="sidebar-link"><i
                                            class="mdi mdi-note-outline"></i><span class="hide-menu"> Manage Staffs
                                        </span></a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{{ route('students.index') }}" class="sidebar-link"><i
                                            class="mdi mdi-note-plus"></i><span class="hide-menu"> Manage Students
                                        </span></a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{{ route('parents.index') }}" class="sidebar-link"><i
                                            class="mdi mdi-note-plus"></i><span class="hide-menu"> Manage Parents
                                        </span></a>
                                </li>
                            </ul>
                        </li>
